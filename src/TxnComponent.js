  ...
  const categoriseAction = (data, txn_type) => {
    ...
    try {
      if (txn_type === "SOL_TRANSFER") {
        ...
        msg = `1 NFT was minted to ${shortenAddress(data.info.owner)}`;
        setRelField(data.info.nft_address ?? "");
                ...
                >
                  <div className="row pt-3">
                    ...
                    >
                      ...
                      {timeIn === "UTC"
                        ? getFullTimeActual(data.timestamp)
                        : getFullTimeLocal(data.timestamp)}
                      <button onClick={setTimeFormat} className="change_btn">
                        <img src={changeBtn} />
                      </button>
                    </div>
                  </div>
                              ...
                              <div className="col-12">
                                <div className={styles.fields_container}>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.merkle_tree}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.merkle_tree ?? "--"
                                              )}
                                            </a>
                                          }
                                        </div>
                                  ...
                                  {action.type === "CREATE_RAFFLE" && (
                                    <div
                                      className={`${styles.only_text} ${styles.slippage_params}`}
                                    >
                                      <div className="d-flex flex-wrap justify-content-start">
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.raffle_creator}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.raffle_creator
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.raffle_address}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.raffle_address
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                        ...
                                        <div className={styles.slippage_param}>
                                          ...
                                          {getFullTime(
                                            action.info.start_date ?? "--"
                                          )}{" "}
                                        </div>
                                        <div className={styles.slippage_param}>
                                          <span>Raffle Ends: </span>{" "}
                                          {getFullTime(
                                            action.info.end_date ?? "--"
                                          )}{" "}
                                        </div>
                                      </div>
                                    </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.fee_taker}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.fee_taker
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.tree_authority}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.tree_authority
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.payer}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.payer ?? "--"
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.old_lender}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.old_lender
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.new_lender}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.new_lender ?? "--"
                                              )}
                                            </a>
                                          }
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.new_loan}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.new_loan ?? "--"
                                              )}
                                            </a>
                                          }
                                        </div>
                                  ...
                                  {action.type === "EXTEND_ESCROW_LOAN" && (
                                    ...
                                    >
                                      <div className="d-flex flex-wrap justify-content-start justify-content-md-start">
                                        ...
                                        {action.info.hasOwnProperty("apy") &&
                                          action.info.apy !== 0 && (
                                            <div
                                              className={styles.slippage_param}
                                            >
                                  ...
                                  {(action.type === "OFFER_LOAN" ||
                                    action.type === "BUY_NOW_PAY_LATER") &&
                                    action.info.hasOwnProperty("apy") &&
                                    (action.info.apy !== 0 ||
                                      action.info.apy !== null) && (
                                      <div
                                        className={`${styles.only_text} ${styles.slippage_params}`}
                                      >
                                        <div className="d-flex flex-wrap justify-content-start justify-content-md-start">
                                  ...
                                  {action.type === "REQUEST_LOAN" &&
                                    (action.info.hasOwnProperty("apy") ||
                                      action.info.hasOwnProperty("ltv") ||
                                      action.info.hasOwnProperty(
                                        "admin_payment"
                                      )) && (
                                      <div
                                        className={`${styles.only_text} ${styles.slippage_params}`}
                                  ...
                                  {action.type === "TAKE_LOAN" &&
                                    (action.info.hasOwnProperty("apy") ||
                                      action.info.hasOwnProperty("discount") ||
                                      action.info.hasOwnProperty(
                                      ...
                                      >
                                        <div className="d-flex flex-wrap justify-content-start justify-content-md-start">
                                          ...
                                          {action.info.hasOwnProperty(
                                            ...
                                            action.info.transfer_to_borrower !==
                                              0 && (
                                              <div
                                                className={
                                                  styles.slippage_param
                                  ...
                                  {action.type === "REPAY_LOAN" &&
                                    (action.info.hasOwnProperty(
                                      "admin_payment"
                                    ) ||
                                      action.info.hasOwnProperty(
                                        "payback_to_liq_owner"
                                      )) && (
                                      <div
                                        className={`${styles.only_text} ${styles.slippage_params}`}
                                      >
                                        <div className="d-flex flex-wrap justify-content-start justify-content-md-start">
                                          ...
                                          {action.info.hasOwnProperty(
                                            ...
                                            action.info.payback_to_liq_owner !==
                                              0 && (
                                              <div
                                                className={
                                                  styles.slippage_param
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.token_vault_one}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.token_vault_one
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.token_vault_two}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.token_vault_two ??
                                                  "--"
                                              )}
                                            </a>
                                          }
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.realm_authority}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.realm_authority
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.governing_token_owner}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.governing_token_source}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.token_owner_record_address}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info
                                    ...
                                    >
                                      <div className="d-flex flex-wrap justify-content-start justify-content-md-start">
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.governance_address}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.governance_address
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.create_authority}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.create_authority
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.governed_account_address}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info
                                        ...
                                        <div className={styles.slippage_param}>
                                          <span>
                                            Base Voting Time:{" "}
                                            {action.info.base_voting_time ??
                                              "--"}
                                          </span>{" "}
                                        </div>
                                        <div className={styles.slippage_param}>
                                          <span>
                                            Min Comm Tokens to create Proposal:{" "}
                                            {formatNumbers(
                                              action.info
                                        ...
                                        <div className={styles.slippage_param}>
                                          <span>
                                            Min Council Tokens to create
                                            Proposal:{" "}
                                            {formatNumbers(
                                              action.info
                                                .min_council_tokens_to_create_proposal ??
                                                "--"
                                            )}
                                          </span>{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.realm_address}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.realm_address
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.governance}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.governance
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.proposal_owner_record}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info
                                            ...
                                            <a
                                              href={
                                                cluster === "mainnet-beta"
                                                  ...
                                                  : `/address/${action.info.governance_authority}?cluster=${cluster}`
                                              }
                                            >
                                              {shortenAddress(
                                                action.info.governance_authority
                                              )}
                                            </a>
                                          ) ?? "--"}{" "}
                                        </div>
                                  ...
                                  {action.type === "CAST_VOTE" && (
                                    ...
                                    >
                                      <div className="d-flex flex-wrap justify-content-start justify-content-md-start">
                                        ...
                                        <div className={styles.slippage_param}>
                                          <span>
                                            Rank: {action.info.rank ?? "--"}
                                          </span>{" "}
                                        </div>
                                        <div className={styles.slippage_param}>
                                          <span>
                                            Weight:{" "}
                                            {action.info.weight_percentage ??
                                              "--"}
                                          </span>{" "}
                                        </div>
                                      </div>
                                    ...
                                    <>
                                      ...
                                      >
                                        <div className="d-flex flex-wrap justify-content-start justify-content-md-start">
                                          ...
                                          >
                                            <span>
                                              Min Council Tokens for Proposal:{" "}
                                              {formatNumbers(
                                                action.info
                                                  .min_council_tokens_to_create_proposal ??
                                                  "--"
              ...
              >
                <div className="col-12">
                  <div className={styles.body_title}>
                    ...
                    <span className={styles.body_title_sub}>
                      ({" "}
                      {Array.isArray(royaltyFeeActions)
                        ? royaltyFeeActions.length
                        : 0}{" "}
                      )
                    </span>
                  </div>
                    ...
                    <div>
                      ...
                      >
                        <button
                          className={styles.expand_button}
                          onClick={() =>
                            setInspectionDepthRaw(!inspectionDepthRaw)
                          }
                        >
                          {inspectionDepthRaw ? (
                            <FaPlusSquare />
