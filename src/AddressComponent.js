...
import { followUser, getFollowData, unFollowUser } from "./utils/dboperations";
...
const AddressComponent = ({
        ...
        toast((t) => (
          ...
          >
            <div className="d-flex">
              ...
              <div className="text_foll">Wallet Followed</div>
            </div>
          </div>
        ));
          ...
          <div className="foll_unfoll_notification">
            <div className="d-flex">
              <div className="icon_foll">
                <img
                  className="img-fluid"
                  src={walletUnfollowed}
                  alt="wallet_followed"
                />
              </div>
              <div className="text_foll">Wallet unfollowed</div>
            </div>
          </div>
        ));
      } else {
  ...
  const connectNFollow = async (wallet_address) => {
    ...
    try {
      ...
      if (signedMessageFromWallet) setClickedConnectLoggedOut(false);
      setFollowLoading("LOADING");
  ...
  return (
    <div>
      ...
      <div className={styles.background_super}>
        ...
        />
        <div className="container pt-2 pb-1"></div>
        {isLoading && (
                ...
                >
                  ...
                  <div className="row pt-2 pt-md-4">
                    ...
                    <div className="col-6 col-lg-6 text-end">
                      <div>
                        <div
                          className={`${styles.wallet_balance_indicator} ${styles.follower_flex}`}
                        >
                    ...
                    <div className="col-6 col-lg-6">
                      <div className={styles.main_heading}>
                        <div className="d-flex">
                          ...
                          {data.manually_parsed_idls ? (
                            ""
                          ) : (
                            <div className="px-1">
                              <button
                                className={styles.update_idl_button}
                                onClick={() => setUpIdlPanel(true)}
                              >
                                {data.idl_available
                                  ? "Update IDL"
                                  : "Upload IDL"}
