...
const SearchComponent = ({
  ...
  const disconnectWallet = () => {
    ...
    toast((t) => (
      <div
        className="foll_unfoll_notification"
      ...
      >
        <div className="d-flex">
          <div className="icon_foll">
            <img
              className="img-fluid"
              src={wallet_Disconnected_loader}
              alt="wallet_followed"
            />
          </div>
          <div className="text_foll">Disconnected</div>
        </div>
      </div>
    ));
    setTimeout(() => {
  ...
  const connectWallet = async (wallet_address) => {
    ...
    const message =
      ...
      "Hi! My name is Translator. I translate Solana for humans.";
  ...
  return (
    <motion.div
      className={styles.header_search_area}
                  ...
                  <div className="flex-fill">
                    <motion.div className={styles.form_container}>
                      <div className={styles.search_n_suggestions}>
                        <div className={styles.form_field_outer}>
                          <div className={styles.form_field_inner}>
                            ...
                            >
                              <div className="d-flex justify-content-start">
                                <div
                                  className={`flex-grow-1 ${styles.input_end}`}
                                >
                        ...
                        {isFocused && (
                          <div className={styles.suggestions_area_outer}>
                            {
                              <motion.div
                                className={styles.suggestions_area}
                                initial={{ opacity: 0 }}
                              ...
                              >
                                ...
                                {wallet.length > 2 && wallet.length < 35 && (
                                  <div>
                                    <div
                                      className={styles.program_search_heading}
                                    >
                                      Program Addresses
                                    </div>
                                    {listOfAddresses
                ...
                <div className={styles.connect_button_container}>
                  <div className={styles.links_list}>
                    {isWalletConnected === "CONN" ? (
                      <>
                        <div className={styles.dropdown_menu}>
                          ...
                          <div className={styles.dropdown_content}>
                            <div
                              className={styles.link_type}
                              onClick={() => setShowFoll(true)}
                            >
                              <img
                                src={follIcon}
                                className={styles.dropdown_image}
                            ...
                            <a
                              className={styles.link_type}
                              href={`http://localhost:3000/address/${connectedWalletAddress}`}
                            >
                              My Account
                            </a>
                            <div
                      ...
                      <button className={styles.wallet_button_header}>
                        <PulseLoader color="#fff" size={8} />
                      </button>
                    ) : (
                      <button
                        onClick={connectWalletOnClick}
                        className={styles.wallet_button_header}
                      >
                        Connect Wallet
                      </button>
                    )}
                    ...
                    <button
                      className={styles.link_info_button}
                      onClick={() => setPopUp(true)}
                    >
                      <img src={infoIcon} />
                    </button>
